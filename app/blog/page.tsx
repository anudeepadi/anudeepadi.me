...
export const metadata: Metadata = {
  title: "Blog | Anudeep Adiraju",
  metadataBase: new URL("https://anudeepadi.me/blog"),
  description: "Read latest stories from Anudeep Adiraju's Blog",
  openGraph: {
    title: "Blog | Anudeep Adiraju",
    url: "https://anudeepadi.me/blog",
    description: "Read latest stories from Anudeep Adiraju's Blog",
    images:
